                            ...
                            <ul>
                                ...
                                <li class="menu nav-item">
                                    ...
                                    <vue-collapsible :isOpen="activeDropdown === 'catalog'">
                                        <ul class="sub-menu text-gray-500">
                                            <li>
                                                <router-link to="/pages/knowledge-base" @click="toggleMobileMenu">Users: Titles</router-link>
                                            </li>
                                            <li>
                                                <router-link to="/pages/knowledge-base" @click="toggleMobileMenu">Users: Types</router-link>
                                            </li>
                                        </ul>
                                    </vue-collapsible>
                                </li>
