            ...
            <div class="datatable invoice-table">
                ...
                >
                    ...
                    <template #amount="data">
                        <div class="font-semibold text-left">{{ data.value.amount }}</div>
                    </template>
                    <template #status="data">
                        <span class="badge" :class="[data.value.status.toLowerCase() === 'finished' ? 'badge-outline-success' : 'badge-outline-danger']">{{
                            data.value.status
                        }}</span>
                    </template>
