                    ...
                    >
                        ...
                        <div class="ltr:ml-auto rtl:mr-auto flex">
                            ...
                            <select class="form-select text-white-dark" @change="selectFilterReportsDate" :disabled="loadingData" v-model="filterDate">
                                <option value="3months" selected>{{t("reports.index.last3months")}}</option>
                                <option value="all">{{t("reports.index.alltime")}}</option>
                    ...
                    >
                        ...
                        <template #actions="data">
                            <div class="flex gap-4 items-center justify-center">
                                <Link
                                    :href="`/service-visit/${data.value.id}/edit`"
...
const cols = computed(() => {
    let baseCols = [
        ...
        { field: "branch.city.name", title: t("client.edit.table.city") },
        { field: "service_reports_count", title: t("report.index.col.noservices") },
