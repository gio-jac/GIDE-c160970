                ...
                <div class="datatable invoice-table">
                    ...
                    >
                        ...
                        <div class="ltr:ml-auto rtl:mr-auto flex">
                            <a v-if="user.type === 1" class="btn btn-outline-dark px-[10px] py-0 w-[45px] h-[37px] mr-2" href="/reports/export">
                            ...
                            <select class="form-select text-white-dark" @change="selectFilterReportsDate" :disabled="loadingData">
