        ...
        <table>
            <tr>
                <td style="width:70%;text-align: left;">
                    <p style="font-weight: normal;font-size:15px;">SERVICE REPORT @if($loop->count>1) ({{ $loop->iteration }}/{{ $loop->count }}) @endif</p>
            ...
            <tr>
                ...
                @foreach ($catalogCodes as $code)
                    <td>
                        ...
                        {{ $code->code }}
                        @if ($code->id === $codeId)
                        <p style="margin: 0;padding:0;border:0;font-size:8px">{{ __('codes.'.$code->id,[],null, $code->description) }}</p>
                        @endif
                    </td>
                @endforeach
            </tr>
